...
public class MenuManager implements ActionListener {
	 ...
	 */
	public MenuManager(DDApp application) {
	 ...
	 */
	public MenuManager(DDApp application, String text) {
		this.application = application;
		this.text=text;
		this.id = "menu-" + Integer.toString(counter++);
		init();
	 ...
	 */
	public MenuManager(DDApp application, String text, String id) {
		this.application = application;
		this.text = text;
		this.id = id;
		init();
	...
	public JMenuItem createMenuItem(JMenu menu, String label, int keyevent, int modifier,
		...
		if (pos < 0) // just add the menu item
			...
			mi = menu.insert(new JMenuItem(label),pos);
	...
	/**
	 * Creates a generic CheckBox menu item within a supplied JMenu
	 * @return the generated JChackBoxMenuItem instance
	 */
	...
	class ExitAction extends AbstractAction {
		...
		protected ExitAction(DDApp application) {
			super("ExitAction");
			this.application = application;
		}
	...
	class AboutAction extends AbstractAction {
		...
		protected AboutAction(DDApp application) {
			super("AboutAction");
			this.application = application;
		}
